<template>
    <div>
            ...
            <div class="relative flex flex-col h-full max-h-full">
                ...
                >
                    ...
                    <button
                        type="button"
                        @click="toggleSidebar"
                        class="flex justify-center items-center size-8 p-[0] text-gray-600 hover:bg-gray-100 rounded-full focus:outline-none"
                    ...
                    <button
                        :class="[
                            isMinified
                                ...
                                : 'w-full h-full flex items-center gap-x-2',
                        ]"
                    >
                        <img
                            class="size-5 rounded-full"
                            src="https://images.unsplash.com/photo-1734122415415-88cb1d7d5dc0?q=80"
                            alt="Avatar"
                        />
                        <span v-if="!isMinified" class="text-sm"
                            >Lim Younghoon</span
                        >
                    </button>
                </footer>
        ...
        >
            ...
            <div v-if="viewState === 1"><calendar-component /></div>
        </div>
    </div>
</template>
